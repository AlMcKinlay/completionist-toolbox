...
const IndexPage = () => (
	...
	<div className="row">
		<div className="col">
      <h3>Contributing</h3>
			<p>The site is completely static, so all lists are defined in the code on
				 the <a href='https://www.github.com/McInkay/completionist-toolbox'>github repository</a>, and
